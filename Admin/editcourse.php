...
if(isset($_REQUEST['requpdate']))
{
    ...
    || ($_REQUEST['course_duration'] == "") || ($_REQUEST['course_author'] == "")
    || ($_REQUEST['course_desc'] == "") || ($_REQUEST['course_original_price'] == "")
    ...
    else 
    {
        ...
        $sql = "UPDATE course SET course_id = '$cid', course_name = '$cname', course_desc = '$cdesc',
         course_author = '$cauthor', course_duration = '$cduration', course_price = '$cprice', course_original_price ='$coriginalprice',
