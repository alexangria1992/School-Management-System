...
if(isset($_REQUEST['courseSubmitBtn']))
{
    ...
    else 
    {
        ...
        course_img, course_duration, course_price, course_original_price) VALUES('$course_name' , 
        '$course_desc', '$course_author', '$img_folder', '$course_duration', '$course_price', 
        ...
        {
            $msg = '<div class="alert alert-danger col-sm-6 ml-5 mt-2">Unable to Add Course Successfully</div>';
